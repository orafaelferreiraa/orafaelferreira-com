...
> Azure Functions composition rules were removed from this fork along with
> `references/services/functions/` — this project doesn't use Azure Functions.
> If that changes, research the current Functions template/composition
> workflow fresh via Microsoft Learn instead of assuming a local recipe exists.
