...
> Sim, eu derrubei a produção. E sim, meu nome estava no log.

O ambiente era crítico, o impacto foi imediato e o culpado tinha nome e sobrenome gravados no log do sistema. Mas o mais importante não foi o erro técnico – foi o que veio depois:

- Como manter a calma quando o negócio está perdendo dinheiro?
...
O UniCesusc fica na SC-401, fácil acesso de carro, Uber, ônibus. Estacionamento disponível, acessibilidade garantida, e toda a estrutura para receber a galera tech de Floripa e região.

## Links e materiais

- [Slides da Apresentação](https://stoblobcertificados011.blob.core.windows.net/palestras/ctrlz.pdf)
- [Post divulgação do evento](https://www.linkedin.com/posts/orafaelferreiraa_codeisland-ctrlz-devops-share-7453042662477062144-nXTz?utm_source=share&utm_medium=member_desktop&rcm=ACoAAAiBr9cBknrEzJyFEqCS03tes6G6R1yclRw)
