...
export const article: Article = {
  ...
  excerpt: "No último dia 26 de abril de 2025, Blumenau foi palco de um grande evento tech do sul do Brasil: o Esquenta MVP Conf, uma amostra da energia e do conteúdo de alto nível que teremos na próxima edição do MVP Conf em São Paulo.",
  content: `# Esquenta MVP Conf Blumenau
