...
export const article: Article = {
  ...
  excerpt: "Como usar o Azure Container Registry como repositório de imagens Docker para implantar uma API no Kubernetes, do build da imagem ao deploy no cluster.",
  content: `![Diagrama do Kubernetes com Azure Container Registry para deploy de API](https://stoblobcertificados011.blob.core.windows.net/imagens-blog/artigos/2023-02-05-artigo-aks-acr1.png)
...
![Fluxo de uso do ACR como repositório de imagens Docker](https://stoblobcertificados011.blob.core.windows.net/imagens-blog/artigos/2023-02-05-artigo-aks-acr2.png)
...
![Build e push da imagem Docker da API para o ACR](https://stoblobcertificados011.blob.core.windows.net/imagens-blog/artigos/2023-02-05-artigo-aks-acr3.png)
...
![Manifesto de deploy da API no Kubernetes usando imagem do ACR](https://stoblobcertificados011.blob.core.windows.net/imagens-blog/artigos/2023-02-05-artigo-aks-acr4.png)
