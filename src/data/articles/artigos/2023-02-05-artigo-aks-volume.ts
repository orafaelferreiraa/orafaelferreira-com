...
export const article: Article = {
  slug: "artigo-aks-volume",
  title: "A importância do Persistent Volume no Kubernetes AKS: garantindo dados seguros e acessíveis",
  excerpt: "Por que Persistent Volume e Persistent Volume Claim são essenciais no Kubernetes AKS: persistência de dados, manifestos YAML e Azure Disk e Azure File.",
  content: `![Ilustração de Persistent Volume no Kubernetes AKS](https://stoblobcertificados011.blob.core.windows.net/imagens-blog/artigos/2023-02-05-artigo-aks-volume1.png)
...
![Exemplo de manifesto YAML para PV e PVC no Kubernetes](https://stoblobcertificados011.blob.core.windows.net/imagens-blog/artigos/2023-02-05-artigo-aks-volume2.png)
...
![Fluxo de criação de recursos no cluster via manifestos YAML](https://stoblobcertificados011.blob.core.windows.net/imagens-blog/artigos/2023-02-05-artigo-aks-volume3.png)
...
![Integração do AKS com Azure Disk e Azure File](https://stoblobcertificados011.blob.core.windows.net/imagens-blog/artigos/2023-02-05-artigo-aks-volume4.png)
