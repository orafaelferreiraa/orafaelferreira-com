...
export const article: Article = {
  slug: "artigo-pipelines-ci-cd",
  title: "Pipelines CI/CD",
  excerpt: "As metodologias ágeis têm mudado a forma como as empresas desenvolvem software, e o desenvolvimento contínuo é uma parte importante dessa mudança.",
  content: `![Ilustração de uma pipeline de CI/CD](https://stoblobcertificados011.blob.core.windows.net/imagens-blog/artigos/2023-02-05-artigo-pipelines.ci.cd1.png)
...
![Fluxo de integração e entrega contínua de software](https://stoblobcertificados011.blob.core.windows.net/imagens-blog/artigos/2023-02-05-artigo-pipelines.ci.cd2.png)
...
![Logo e interface do Jenkins para automação de pipelines](https://stoblobcertificados011.blob.core.windows.net/imagens-blog/artigos/2023-02-05-artigo-pipelines.ci.cd3.png)
...
![Workflow do GitHub Actions executando uma pipeline](https://stoblobcertificados011.blob.core.windows.net/imagens-blog/artigos/2023-02-05-artigo-pipelines.ci.cd4.png)
...
![Pipeline de CI/CD no Azure DevOps](https://stoblobcertificados011.blob.core.windows.net/imagens-blog/artigos/2023-02-05-artigo-pipelines.ci.cd5.png)
