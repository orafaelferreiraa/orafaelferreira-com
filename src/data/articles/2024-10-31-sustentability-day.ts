...
export const article: Article = {
  ...
  excerpt: "No último dia 22 de outubro, o CNCF - Cloud Native São Paulo 🇧🇷, em parceria com a Amazon Web Services (AWS) e a Cloud Native Computing Foundation (CNCF), organizou o aguardado evento \"Sustainability Day\" no AWS Startup Loft em São Paulo.",
  content: `
