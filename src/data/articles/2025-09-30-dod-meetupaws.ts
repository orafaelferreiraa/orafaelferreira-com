...
export const article: Article = {
  ...
  excerpt: "No dia 03 de setembro de 2025, participei como palestrante no Encontro das comunidades AWS User Group Floripa + DevOps Floripa, realizado no Auditório da ACATE - Passeio Primavera (SC-401).",
  content: `
