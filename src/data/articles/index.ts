...
export const allArticles: Article[] = [
  ...
  // TODO: Add remaining articles here as they are created
  // The format should be: import { article as variableName } from './YYYY-MM-DD-slug';
  // Then add variableName to the array above
