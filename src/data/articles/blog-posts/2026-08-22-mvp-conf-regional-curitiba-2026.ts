...
export const article: Article = {
  ...
  excerpt: "MVP Conf Regional Curitiba 2026: como Platform Engineering combate o Shadow Ops com uma plataforma serverless self-service em Terraform e GitHub Actions.",
  content: `
# MVP Conf Regional Curitiba 2026

![Rafael Ferreira no MVP Conf Regional Curitiba 2026 na PUC PR](https://stoblobcertificados2.blob.core.windows.net/imagens-blog/2026/2026/mvp-ctba/00.jpg)
...
![Slide de abertura da palestra Platform Engineering na Prática](https://stoblobcertificados2.blob.core.windows.net/imagens-blog/2026/2026/mvp-ctba/1.jpg)
...
![Slide sobre o anti-padrão do Shadow Ops](https://stoblobcertificados2.blob.core.windows.net/imagens-blog/2026/2026/mvp-ctba/2.jpg)
...
![Slide explicando Platform Engineering como produto interno](https://stoblobcertificados2.blob.core.windows.net/imagens-blog/2026/2026/mvp-ctba/5.jpg)
...
![Slide com os cinco planos da anatomia de um IDP](https://stoblobcertificados2.blob.core.windows.net/imagens-blog/2026/2026/mvp-ctba/6.jpg)
...
![Slide sobre a experiência do desenvolvedor em uma plataforma interna](https://stoblobcertificados2.blob.core.windows.net/imagens-blog/2026/2026/mvp-ctba/7.jpg)
...
![Slide do reusable workflow com terraform fmt, TFLint, Trivy e Checkov](https://stoblobcertificados2.blob.core.windows.net/imagens-blog/2026/2026/mvp-ctba/8.jpg)
...
<i class="fa-regular fa-folder-open"></i> **Slides da Apresentação:** [Platform Engineering: Construindo uma Plataforma Serverless Self-Service](https://stoblobcertificados2.blob.core.windows.net/palestras/Platform_Engineering-MVP-CRTB.pdf)
...
![Rafael Ferreira palestrando no MVP Conf Regional Curitiba 2026](https://stoblobcertificados2.blob.core.windows.net/imagens-blog/2026/2026/mvp-ctba/9.jpg)
`,
  date: "2026-08-22",
  category: "Palestras",
