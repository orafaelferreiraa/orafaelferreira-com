...
export const article: Article = {
  slug: "azbkpshouldenabledvm",
  title: "Azure Backup should be enabled for Virtual Machines",
  excerpt: "Vamos explorar por que a policy “Azure Backup should be enabled for Virtual Machines” (ID: ) é essencial em ambientes corporativos.",
  content: `
