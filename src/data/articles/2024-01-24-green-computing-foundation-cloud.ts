...
export const article: Article = {
  slug: "green-computing-foundation-cloud",
  title: "Antes do Cloud Native: Construindo uma Fundação Sólida para a Nuvem Impactando um Futuro Sustentável",
  excerpt: "Em um mundo cada vez mais digital, inovações em tecnologias Cloud Native não são apenas uma questão de avanço tecnológico, mas também impactam mudança social e ambiental.",
  content: `
## Introdução
