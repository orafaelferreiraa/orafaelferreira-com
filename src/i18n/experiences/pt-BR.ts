...
description: "Atuo como Senior Azure Platform Engineer em um time global de Cloud & DevOps com foco em plataformas Azure em escala corporativa (Enterprise-scale) e Platform Engineering. Trabalho no design e evolução de uma plataforma de nuvem segura, escalável e automatizada, permitindo que múltiplos times de engenharia provisionem e operem workloads em nuvem de forma eficiente, padronizada e segura.\n• Projetar e implementar infraestrutura Azure em escala corporativa utilizando Terraform (Infrastructure as Code), permitindo ambientes padronizados e reutilizáveis.\n• Construir, manter e otimizar pipelines de CI/CD com GitHub Actions, viabilizando deploys automatizados em múltiplos ambientes.\n• Conduzir a evolução das Azure Landing Zones com frameworks de governança, incluindo aplicação de políticas e padronização de ambientes.\n• Operar e otimizar plataformas Kubernetes baseadas em AKS, implementando práticas de GitOps com ArgoCD e Helm para suportar arquiteturas de microsserviços escaláveis.\n• Implementar soluções de observabilidade e monitoramento com Prometheus, Alertmanager, Thanos e Grafana, garantindo confiabilidade da plataforma e detecção proativa de incidentes.\n• Definir e implementar estratégias de FinOps e otimização de custos, identificando recursos não utilizados ou superdimensionados e melhorando a eficiência operacional.\n• Conduzir iniciativas de automações self-service utilizando a plataforma, reduzindo operações manuais e melhorando a produtividade dos times de engenharia.\n• Projetar e implementar soluções de automação utilizando Python, Bash e PowerShell, utilizando ferramentas de IA para acelerar o desenvolvimento e reduzir atividades manuais.\n• Conduzir práticas de Cloud Governance e DevSecOps e colaborar com times de Arquitetura, Desenvolvimento e Dados na definição de soluções técnicas e evolução da plataforma, promovendo boas práticas de Azure e DevOps e melhorias contínuas de confiabilidade e escalabilidade.",
