export const experiencesPT = [
  {
    ...
    description: "Atuo em um time global focado em inovação de Cloud & DevOps, com foco em Azure Enterprise-scale, Platform Engineering, AKS, Terraform, GitOps, Cloud Governance, DevSecOps, Observability e FinOps. Trabalho no design e evolução de uma plataforma Azure segura, escalável, automatizada e multi-tenant com mais de 15 clusters AKS, habilitando múltiplos times de engenharia com mais de 300 pessoas a provisionar, implantar e operar cerca de 8.000 workloads em nuvem com autonomia, padronização e governança.\n• Definição e evolução de padrões de infraestrutura Azure com Terraform/IaC, módulos reutilizáveis, provisionamento padronizado e suporte a ambientes multi-tenant.\n• Construção e otimização de pipelines CI/CD com GitHub Actions, integrando práticas de GitOps com ArgoCD e Helm para deploys automatizados em múltiplos ambientes.\n• Evolução de Azure Landing Zones e governança cloud com Policy as Code, definindo padrões, políticas, controles de compliance e guardrails multi-subscription.\n• Definição de governança e segurança em nível de cluster com Kyverno e OPA Gatekeeper para admission control e policy-as-code.\n• Evolução da camada de ingress e do autoscaling dos clusters AKS com KEDA (autoscaling orientado a eventos) e migração progressiva de NGINX Ingress para Envoy Gateway (Gateway API).\n• Hardening da esteira de CI/CD com Actions Runner Controller (runners self-hosted no AKS).\n• Implementação de soluções de observabilidade e monitoramento com Prometheus, Alertmanager, Thanos, Grafana, Loki, Grafana Alloy e OpenTelemetry, garantindo confiabilidade da plataforma e detecção proativa de incidentes.\n• Atuação em conectividade Azure com Virtual WAN, Hub-and-Spoke, Azure Firewall, Private DNS, VNet Peering, APIM e Application Gateway.\n• Definição e implementação de estratégias de FinOps e otimização de custos com apoio de PerfectScale e Vantage, identificando recursos não utilizados ou superdimensionados e melhorando a eficiência operacional.\n• Projeto e implementação de soluções de automação com Docker, Python, Bash e PowerShell, utilizando ferramentas de IA para acelerar o desenvolvimento e reduzir atividades manuais.\n• Colaboração com times de Arquitetura, Desenvolvimento e Dados na definição de soluções técnicas e evolução da plataforma, promovendo boas práticas de Azure e DevOps e melhorias contínuas de confiabilidade e escalabilidade.\n• Liderança de uma iniciativa de FinOps em escala corporativa na Azure, gerando mais de US$ 1 milhão em economia anual, com right-sizing de compute non-prod em AKS, right-sizing de bancos de dados SQL, limpeza de discos e armazenamento órfãos e otimização de recursos Kubernetes (limites de réplicas, pipelines de log duplicados), implementando guardrails de Azure Policy/Kyverno para prevenir regressão de custos.",
